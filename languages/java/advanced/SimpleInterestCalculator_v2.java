...
public class SimpleInterestCalculator_v2 extends JFrame {
    private JSlider principalSlider, rateSlider, timeSlider;
    private JLabel principalLabel, rateLabel, timeLabel, interestLabel, totalAmountLabel;
    private JPanel chartPanel;

    public SimpleInterestCalculator_v2() {
    ...
    private void updateResults() {
        ...
        rateLabel.setText("Rate of Interest: " + rate + "%");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            SimpleInterestCalculator_v2 calculator = new SimpleInterestCalculator_v2();
